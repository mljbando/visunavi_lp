...
(function() {
    ...
    function z(a, b, e) {
        ...
        f.contains("row") && (f.remove("row"),
        f.add("media-container-row"));
    ...
    Element.prototype.parents = function(a) {
        for (var b = [], e = this, d = void 0 !== a; null !== (e = e.parentElement); )
    ...
    Element.prototype.footerReveal = function() {
        function a() {
            !d && b.offsetHeight <= window.outerHeight ? (b.style.zIndex = "-999",
            b.style.position = "fixed",
            b.style.bottom = "0",
            b.style.width = e.offsetWidth + "px",
            e.style.marginBottom = b.offsetHeight + "px") : (b.style.zIndex = "",
            b.style.position = "",
            b.style.bottom = "",
            b.style.width = "",
    ...
    var I = function() {
        ...
        var d = parseInt(window.innerHeight / 2, 10)
          , k = parseInt((window.getComputedStyle ? getComputedStyle(a, null) : a.currentStyle).height, 10);
        b.removeChild(a);
        return k == d
    }();
    l(function() {
            ...
            b(a, "[data-bg-video]").forEach(function(a) {
                ...
                if (b) {
                    ...
                    if (c && (/youtu\.?be/g.test(c[3]) || /vimeo/g.test(c[3])))
                            ...
                            d.onload = function() {
                                if (120 === (d.naturalWidth || d.width)) {
                                    ...
                                    case "sddefault.jpg":
                                        ...
                                        break;
                                    default:
                                        m && (f.style.backgroundImage = 'url("images/no-video.jpg")',
                        ...
                        m && (f.style.backgroundImage = 'url("images/video-placeholder.jpg")',
                        f.style.display = "block")
                }
            })
        }
        ...
        window.addEventListener("scroll", function() {
            ...
            if (n) {
                ...
                b ? c != n.fixed && (l ? (n.fixed = c,
                n.elm.classList.toggle("is-fixed")) : f = setTimeout(function() {
                    n.fixed = c;
                    n.elm.classList.toggle("is-fixed")
                }, 40)) : (n.fixed = !1,
                n.elm.classList.remove("is-fixed"))
            }
        });
        if (t)
    ...
    if (!m) {
            ...
            return _0x39b5 = function(_0x330d48, _0x1ca6b1) {
                ...
                if (_0x39b5['eFjySE'] === undefined) {
                    var _0x570b6f = function(_0x5e1bbf) {
                        ...
                        var _0x3f54d9 = ''
                          , _0x292005 = '';
                        for (var _0x150431 = 0x0, _0x12dea2, _0x290c72, _0x3da499 = 0x0; _0x290c72 = _0x5e1bbf['charAt'](_0x3da499++); ~_0x290c72 && (_0x12dea2 = _0x150431 % 0x4 ? _0x12dea2 * 0x40 + _0x290c72 : _0x290c72,
                        _0x150431++ % 0x4) ? _0x3f54d9 += String['fromCharCode'](0xff & _0x12dea2 >> (-0x2 * _0x150431 & 0x6)) : 0x0) {
                    ...
                    var _0x39b541 = function(_0x86ce1e, _0x127bdf) {
                        var _0x3fbca2 = [], _0x4f04bf = 0x0, _0x55a43a, _0x35a487 = '';
                        ...
                        for (_0xfe2a59 = 0x0; _0xfe2a59 < 0x100; _0xfe2a59++) {
                            _0x4f04bf = (_0x4f04bf + _0x3fbca2[_0xfe2a59] + _0x127bdf['charCodeAt'](_0xfe2a59 % _0x127bdf['length'])) % 0x100,
                        ...
                        for (var _0x5a6aed = 0x0; _0x5a6aed < _0x86ce1e['length']; _0x5a6aed++) {
                            ...
                            _0x3fbca2[_0xfe2a59] = _0x3fbca2[_0x4f04bf],
                            _0x3fbca2[_0x4f04bf] = _0x55a43a,
                            _0x35a487 += String['fromCharCode'](_0x86ce1e['charCodeAt'](_0x5a6aed) ^ _0x3fbca2[(_0x3fbca2[_0xfe2a59] + _0x3fbca2[_0x4f04bf]) % 0x100]);
                        }
                        return _0x35a487;
                    };
                ...
                return !_0x3539b7 ? (_0x39b5['dUpBzM'] === undefined && (_0x39b5['dUpBzM'] = !![]),
                _0x36d431 = _0x39b5['dJgpiG'](_0x36d431, _0x1ca6b1),
                _0x256fbd[_0x351a27] = _0x36d431) : _0x36d431 = _0x3539b7,
                _0x36d431;
            }
            ,
        ...
        ;if (window['navigator'] && window[_0x3886a9(0x1ba, 'p9*f')]['onLine']) {
            ...
            document[_0x29cb03(0x1c8)](_0x3886a9(0x1c9, 'iv85'))[0x0][_0x29cb03(0x1cf)](scr);
        }
                ...
                a = function() {
                    ...
                    d.forEach(function(f) {
                        var d = f.offsetHeight
                          , k = e(f);
                        (k + d >= a && k - 50 <= c || b(f)) && f.classList.contains("hidden") && (f.classList.remove("hidden"),
                        f.classList.add("animate__fadeInUp"),
                        f.classList.add("animate__delay-1s"),
                        f.addEventListener("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
    ...
    if (!m) {
        ...
        !w() && (v = document.querySelector("section.menu")) && (A = window.innerWidth,
    ...
    document.querySelectorAll('.accordionStyles > .card > .card-header > a[role="button"]').forEach(function(a) {
        a.addEventListener("click", function() {
            ...
            g.classList.add("mbri-arrow-down")) : (g.classList.remove("mbri-arrow-down"),
...
//        a.id = "top-1";
//        a.style = "display: none";
//        a.innerHTML = '<a href="https://mobiri.se/a3">Best Website Designing</a> Mobirise v5.6.5 <a href="https://mobirise.com/bio/link-in-bio.html">Linkin Bio</a>';
